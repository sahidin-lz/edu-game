...
export function AuthButton({ user, onOpenProfile }: Props) {
  ...
  if (user) {
    return (
      ...
      >
        ...
        <span className="text-[10px] uppercase tracking-widest font-bold text-slate-300 hidden md:inline group-hover:text-emerald-400">
          Profil Siswa
        </span>
      </button>
    );
